...
class Obstacle(pygame.sprite.Sprite):
    ...
    def update(self):
        self.animation_state()
        if score >= 20 and score < 40: self.rect.x -= 8
        elif score >= 40 and score < 60: self.rect.x -= 10
        elif score >= 60 and score < 80: self.rect.x -= 12
        elif score >= 80: self.rect.x -= 15
        else: self.rect.x -= 6
        self.destroy()
...
def display_score():
    ...
    ##############################(teksti, AA, väri)
    score_surf = test_font.render(f'{curr_time}',False,(70,70,70))
...
game_name = test_font.render('Platform Runner', False, (110, 200, 170))
